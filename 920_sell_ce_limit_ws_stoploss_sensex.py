#!/usr/bin/env python
"""
09:20 SENSEX ATM CE short strategy using websocket LTP ticks.
...
- Buffer (Limit Offset) increased to 3 points for SENSEX.
"""
...
STRATEGY = os.getenv("STRATEGY_NAME", "920 Sell CE Limit WS SL SENSEX")
UNDERLYING = "SENSEX"
...
# Increased buffer to 3 points as requested
ENTRY_LIMIT_OFFSET_POINTS = 3.0
EXIT_LIMIT_OFFSET_POINTS = 3.0
TICK_SIZE = 0.05

ENTRY_FILL_TIMEOUT_SECONDS = 20.0
EXIT_FILL_TIMEOUT_SECONDS = 10.0
EXIT_REPRICE_ATTEMPTS = 10
STOPLOSS_MAX_SPREAD_POINTS = 3.0
